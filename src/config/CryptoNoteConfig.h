...
const uint64_t DIFFICULTY_TARGET                             = 90; // recommended : 80 or 60 --> 90 seconds
...
For example:
TurtleGoldd --print-genesis-tx --genesis-block-reward-address TRTLv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(10); // 1
...
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 1000000; // unused
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 1000000; // unused
...
const uint64_t MAX_EXTRA_SIZE_V2_HEIGHT                      = 1000000; // recommended : 0
...
const char     CRYPTONOTE_NAME[]                             = "NewGold";
...
const int      P2P_DEFAULT_PORT                              =  19263;
const int      RPC_DEFAULT_PORT                              =  19264;
const int      SERVICE_DEFAULT_PORT                          =  19265;
...
{
    {  0xb8, 0x0c, 0x4a, 0x6c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0x92, 0xa4, 0xb6, 0xc1, 0x43, 0xe1  }
};
